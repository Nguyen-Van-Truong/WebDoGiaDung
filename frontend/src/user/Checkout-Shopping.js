                                                    ...
                                                    <li className="pb-4">
                                                        <div className="flex items-center justify-between">
                                                            <div className="flex items-center gap-1">
                                                                <div>
                                                                    <img src="../assets/images/all-img/cart-01.png"
                                                                         alt=""/>
                                                                </div>
                                                                <div className="px-2">
                                                                    <h2 className="text-gray-black"><span>Isolate Sofa Chair</span>
                                                                        <span className="text-[#636270]">x5</span></h2>
                        ...
                        <div className=" flex flex-wrap gap-y-6 justify-between">
                            ...
                            <div className="footer-widget">
                                ...
                                <ul className="flex flex-col gap-3">
                                    ...
                                    <li>
                                        <a href="#"
                                           className="footer-link text-[#272343] text-base leading-[110%] hover:text-[#007580] transition-all duration-500 inline-block pb-1">wooden
                                            Chair</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                           className="footer-link text-[#272343] text-base leading-[110%] hover:text-[#007580] transition-all duration-500 inline-block pb-1">Park
                                            Bench</a>
                                    </li>
                                </ul>
                            </div>
