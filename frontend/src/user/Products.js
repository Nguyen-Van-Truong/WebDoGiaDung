                    ...
                    <div className="main-header bg-grayscales-500 lg:border-none border-b border-grayscales-700">
                        <div className="container px-3 md:px-5 xl:px-0">
                            <div className="flex justify-between items-center py-5">
                                ...
                                <div className="lg:hidden inline-block hamburger-btn" id="hamburger-btn"  onClick={handleMenuClick}>
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                </div>
        ...
        <span className="text-gray-black inline-flex">
          {/* SVG remains unchanged */}
            ...
            <section className="">
                ...
                <div className="product-list-area shadow-[inset_0px_1px_0px_#E1E3E6]" style={{backgroundColor: "var(--bg-breadcum)"}}>
                    <div className="container px-3 md:px-5 xl:px-0">
                        <div className="products-wrapper py-6 xl:grid-cols-4 sm:grid-cols-2 md:grid-cols-3 grid grid-cols-1 gap-6">
