                ...
                <div className="container px-3_t md:px-5 xl:px-0">
                    <div className=" flex flex-wrap gap-y-6 justify-between">
                        <div className="footer-widget max-w-[350px]">
                            ...
                            <p className="lg:mb-6 mb-4 text-gray-black text-base"> </p>
                        ...
                        <div className="footer-widget">
                            <h2 className="widget-title text-[#9A9CAA] text-sm leading-[110%] font-display font-medium uppercase mb-5">Danh mục</h2>
                            <ul className="flex flex-col gap-3">
                                <li>
                                    <a href="#"
                                       className="footer-link text-gray-black text-base leading-[110%] hover:text-[#007580] transition-all duration-500 inline-block pb-1 ease-in-out">Bàn ghế</a>
                                </li>
                                <li>
                                    <a href="#"
                                       className="footer-link text-gray-black text-base leading-[110%] hover:text-[#007580] transition-all duration-500 inline-block pb-1">Bếp điện từ</a>
                                </li>
                                <li>
                                    <a href="#"
                                       className="footer-link text-gray-black text-base leading-[110%] hover:text-[#007580] transition-all duration-500 inline-block pb-1">Nồi cơm</a>
                                </li>
                                <li>
                                    <a href="#"
                                       className="footer-link text-gray-black text-base leading-[110%] hover:text-[#007580] transition-all duration-500 inline-block pb-1">Tủ lạnh</a>
                                </li>
                                <li>
                                    <a href="#"
                                       className="footer-link text-gray-black text-base leading-[110%] hover:text-[#007580] transition-all duration-500 inline-block pb-1">Quạt</a>
                                </li>
                        ...
                        <div className="footer-widget">
                            <h2 className="widget-title text-[#9A9CAA] text-sm leading-[110%] font-display font-medium uppercase mb-5">Hỗ trợ</h2>
                            <ul className="flex flex-col gap-3">
                                <li>
                                    <a href="#"
                                       className="footer-link text-gray-black text-base leading-[110%] hover:text-[#007580] transition-all duration-500 inline-block pb-1">Hỗ trợ và giúp đỡ</a>
                                </li>

                                <li>
                                    <a href="#"
                                       className="footer-link text-gray-black text-base leading-[110%] hover:text-[#007580] transition-all duration-500  inline-block pb-1">Chính sách</a>
                                </li>
                        ...
                        <div className="footer-widget w-[424px]">
                            ...
                            <p className="py-3 text-gray-black opacity-60"></p>
                        </div>
            ...
            <div className="footer-bottom shadow-[inset_0px_1px_0px_#E1E3E6] py-6">
                <div className="container px-3_t md:px-5 xl:px-0">
                    <div
                        ...
                        <p className="text-center text-[#9A9CAA]"></p>
