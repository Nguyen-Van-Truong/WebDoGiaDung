                                    ...
                                    <div className="col">
                                        <div className="card">
                                            <div className="product">
                                                ...
                                                <div className="product-content p-3">
                                                    <span className="rating mb-2 d-block"><i
                                                        className="icofont-star text-warning"/> 3.5 (77)</span>
                                                    <a href="product-detail.html" className="fw-bold">Wall Clock </a>
                                                    <p className="text-muted">Reference 1004</p>
                                                    <span className="d-block fw-bold fs-5 text-secondary">$ 399</span>
                                                    <a href="product-cart.html" className="btn btn-primary mt-3"> Add to
                                                        Cart</a>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col">
                                        <div className="card">
                                            <div className="product">
                                                ...
                                                <div className="product-content p-3">
                                                    <span className="rating mb-2 d-block"><i
                                                        className="icofont-star text-warning"/> 3.5 (98)</span>
                                    ...
                                    <div className="col">
                                        <div className="card">
                                            <div className="product">
                                                <div className="product-image">
                                                    <div className="product-item active">
                                                        <img src="assets/images/product/product-4.jpg" alt="product"
                                                             className="img-fluid w-100"/>
                                                    </div>
                                                    <a className="add-wishlist" href="#">
                                                        <i className="bi bi-heart-fill text-danger"/>
                                                ...
                                                <div className="product-content p-3">
                                                    <span className="rating mb-2 d-block"><i
                                                        className="icofont-star text-warning"/> 4.5 (1455)</span>
                                                    <a href="product-detail.html" className="fw-bold">Flower Port </a>
                                                    <p className="text-muted">Reference 1414</p>
                                                    <span className="d-block fw-bold fs-5 text-secondary">$ 399</span>
                                                    <a href="product-cart.html" className="btn btn-primary mt-3"> Add to
                                                        Cart</a>
                                                </div>
                                        ...
                                        <div className="card">
                                            <div className="product">
                                                ...
                                                <div className="product-content p-3">
                                                    <span className="rating mb-2 d-block"><i
                                                        className="icofont-star text-warning"/> 4.5 (145)</span>
                                                    <a href="product-detail.html" className="fw-bold">School Bag </a>
                                                    <p className="text-muted">Reference 1000</p>
                                                    <span className="d-block fw-bold fs-5 text-secondary">$ 149</span>
                                                    <a href="product-cart.html" className="btn btn-primary mt-3"> Add to
                                                        Cart</a>
                                                </div>
                                    ...
                                    <div className="col">
                                        <div className="card">
                                            <div className="product">
                                                ...
                                                <div className="product-content p-3">
                                                    <span className="rating mb-2 d-block"><i
                                                        className="icofont-star text-warning"/> 4.5 (1245)</span>
                                                    <a href="product-detail.html" className="fw-bold">Rado Watch </a>
                                                    <p className="text-muted">Reference 9204</p>
                                                    <span className="d-block fw-bold fs-5 text-secondary">$ 399</span>
                                                    <a href="product-cart.html" className="btn btn-primary mt-3"> Add to
                                                        Cart</a>
                                                </div>
                                    ...
                                    <div className="col">
                                        <div className="card">
                                            <div className="product">
                                                <div className="product-image">
                                                    <div className="product-item active">
                                                        <img src="assets/images/product/product-7.jpg" alt="product"
                                                             className="img-fluid w-100"/>
                                                    </div>
                                                    <a className="add-wishlist" href="#">
                                                        <i className="bi bi-heart-fill text-danger"/>
                                                ...
                                                <div className="product-content p-3">
                                                    <span className="rating mb-2 d-block"><i
                                                        className="icofont-star text-warning"/> 4.5 (1045)</span>
                                                    <a href="product-detail.html" className="fw-bold">Traveling Bag </a>
                                                    <p className="text-muted">Reference 1155</p>
                                                    <span className="d-block fw-bold fs-5 text-secondary">$ 399</span>
                                                    <a href="product-cart.html" className="btn btn-primary mt-3"> Add to
                                                        Cart</a>
                                                </div>
                                    ...
                                    <div className="col">
                                        <div className="card">
                                            <div className="product">
                                                ...
                                                <div className="product-content p-3">
                                                    <span className="rating mb-2 d-block"><i
                                                        className="icofont-star text-warning"/> 4.5 (77)</span>
                                                    <a href="product-detail.html" className="fw-bold">Wall Clock </a>
                                                    <p className="text-muted">Reference 1004</p>
                                                    <span className="d-block fw-bold fs-5 text-secondary">$ 399</span>
                                                    <a href="product-cart.html" className="btn btn-primary mt-3"> Add to
