                                    ...
                                    <div className="row g-3 mb-3">
                                        ...
                                        <div className="col-xxl-12 col-xl-12 col-lg-12">
                                            <div className="docs-preview clearfix">
                                                <div ref={previewLarge} className="img-preview preview-lg"></div>
                                                <div ref={previewMedium} className="img-preview preview-md"></div>
                                                <div ref={previewSmall} className="img-preview preview-sm"></div>
