              ...
              <span className="logo-icon">
                <i className="bi bi-bag-check-fill fs-4"/>
                        ...
                        <ul className="menu-list flex-grow-1 mt-3">
                            ...
                            <li className="collapsed">
                                <a className="m-link" data-bs-toggle="collapse" data-bs-target="#customers-info"
                                   href="#">
                                                ...
                                                <div className="row g-3 align-items-center">
                                                    ...
                                                    <div className="col-md-12">
                                                        ...
                                                        <div className="input-group mb-3">
                                                            <span
                                                                className="input-group-text">https://eBazar.com/</span>
                                                            <input type="text" className="form-control"/>
                                                        </div>
                                                    </div>
                                                    <div className="col-md-12">
                                            ...
                                            <form>
                                                <div className="row g-3 align-items-center">
                                                    <div className="col-md-12">
                                                        ...
                                                        <small className="d-block text-muted mb-2">Only portrait or
                                                            square images, 2M max and 2000px max-height.</small>
