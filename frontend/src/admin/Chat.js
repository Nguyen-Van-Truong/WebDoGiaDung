                                ...
                                <div className="card card-chat border-right border-top-0 border-bottom-0  w380">
                                    <div className="px-4 py-3 py-md-4">
                                        ...
                                        <div className="nav nav-pills justify-content-between text-center"
                                             role="tablist">
                                            <a className="flex-fill rounded border-0 nav-link active"
                                               data-bs-toggle="tab" href="#chat-recent" role="tab"
                                               aria-selected="true">Chat</a>
                                            <a className="flex-fill rounded border-0 nav-link" data-bs-toggle="tab"
                                               href="#chat-groups" role="tab" aria-selected="false">Ecommerce Groups</a>
                                            <a className="flex-fill rounded border-0 nav-link" data-bs-toggle="tab"
                                               href="#chat-contact" role="tab" aria-selected="false">Contact</a>
                                        </div>
                                    </div>
                                            ...
                                            <ul className="list-unstyled list-group list-group-custom list-group-flush mb-0">
                                                <li className="list-group-item px-md-4 py-3 py-md-4">
                                                    <a href="javascript:void(0);" className="d-flex">
                                                        ...
                                                        <div className="flex-fill ms-3 text-truncate">
                                                            <h6 className="d-flex justify-content-between mb-0"><span>Vanessa Knox</span>
                                                                <small className="msg-time">10:45 AM</small></h6>
                                                ...
                                                <li className="list-group-item px-md-4 py-3 py-md-4">
                                                    <a href="javascript:void(0);" className="d-flex">
                                                        ...
                                                        <div className="flex-fill ms-3 text-truncate">
                                                            <h6 className="d-flex justify-content-between mb-0"><span>Abigail Bell</span>
                                                                <small className="msg-time">11:45 AM</small></h6>
                                                ...
                                                <li className="list-group-item px-md-4 py-3 py-md-4">
                                                    <a href="javascript:void(0);" className="d-flex">
                                                        <div className="avatar rounded no-thumbnail">RH</div>
                                                        <div className="flex-fill ms-3 text-truncate">
                                                            <h6 className="d-flex justify-content-between mb-0"><span>Diane Blake</span>
                                                                <small className="msg-time">12:45 AM</small></h6>
                                                ...
                                                <li className="list-group-item px-md-4 py-3 py-md-4">
                                                    <a href="javascript:void(0);" className="d-flex">
                                                        ...
                                                        <div className="flex-fill ms-3 text-truncate">
                                                            <h6 className="d-flex justify-content-between mb-0"><span>Megan Dyer</span>
                                                                <small className="msg-time">12:46 AM</small></h6>
                                                            <span
                                                                className="text-muted">Contrary to popular belief</span>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li className="list-group-item px-md-4 py-3 py-md-4">
                                                    <a href="javascript:void(0);" className="d-flex">
                                                        ...
                                                        <div className="flex-fill ms-3 text-truncate">
                                                            <h6 className="d-flex justify-content-between mb-0"><span>Abigail Bell</span>
                                                                <small className="msg-time">12:47 PM</small></h6>
                                                            <span className="text-muted">changed an issue from "In Progress" to</span>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li className="list-group-item px-md-4 py-3 py-md-4">
                                                    <a href="javascript:void(0);" className="d-flex">
                                                        ...
                                                        <div className="flex-fill ms-3 text-truncate">
                                                            <h6 className="d-flex justify-content-between mb-0"><span>Diane Blake</span>
                                                                <small className="msg-time">12:48 PM</small></h6>
                                                            <span
                                                                className="text-muted">making it over 2000 years old</span>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li className="list-group-item px-md-4 py-3 py-md-4 open">
                                                    <a href="javascript:void(0);" className="d-flex">
                                                        ...
                                                        <div className="flex-fill ms-3 text-truncate">
                                                            <h6 className="d-flex justify-content-between mb-0"><span>Vanessa Knox</span>
                                                                <small className="msg-time">12:49 PM</small></h6>
                                                            <span className="text-muted">There are many variations of passages</span>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li className="list-group-item px-md-4 py-3 py-md-4">
                                                    <a href="javascript:void(0);" className="d-flex">
                                                        ...
                                                        <div className="flex-fill ms-3 text-truncate">
                                                            <h6 className="d-flex justify-content-between mb-0"><span>Donna Grant</span>
                                                                <small className="msg-time">Thu</small></h6>
                                                ...
                                                <li className="list-group-item px-md-4 py-3 py-md-4">
                                                    <a href="javascript:void(0);" className="d-flex">
                                                        ...
                                                        <div className="flex-fill ms-3 text-truncate">
                                                            <h6 className="d-flex justify-content-between mb-0"><span>Diane Blake</span>
                                                                <small className="msg-time">Wed</small></h6>
                                                            <span className="text-muted">It is a long established fact that a reader will be distracted</span>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li className="list-group-item px-md-4 py-3 py-md-4">
                                                    <a href="javascript:void(0);" className="d-flex">
                                                        ...
                                                        <div className="flex-fill ms-3 text-truncate">
                                                            <h6 className="d-flex justify-content-between mb-0"><span>Vanessa Knox</span>
                                                                <small className="msg-time">13/10/2020</small></h6>
                                                            <span className="text-muted">There are many variations of passages</span>
                                                        </div>
                                                    </a>
                                                </li>
                                                ...
                                                <li className="list-group-item px-md-4 py-3 py-md-4">
                                                    <a href="javascript:void(0);" className="d-flex">
                                                        ...
                                                        <div className="flex-fill ms-3 text-truncate">
                                                            <h6 className="d-flex justify-content-between mb-0"><span>Diane Blake</span>
                                                                <small className="msg-time">22/10/2020</small></h6>
                                                            <span
                                                                className="text-muted">making it over 2000 years old</span>
                                                        </div>
                                                    </a>
                                                ...
                                                <li className="list-group-item px-md-4 py-3 py-md-4">
                                                    <a href="javascript:void(0);" className="d-flex">
                                                        ...
                                                        <div className="flex-fill ms-3 text-truncate">
                                                            ...
                                                            <span
                                                                className="text-muted">The point of using Lorem Ipsum</span>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li className="list-group-item px-md-4 py-3 py-md-4">
                                        ...
                                        <div className="tab-pane fade" id="chat-contact" role="tabpanel">
                                            <ul className="list-unstyled list-group list-group-custom list-group-flush mb-0">
                                                <li className="list-group-item px-md-4 py-3 py-md-4">
                                                    <a href="javascript:void(0);" className="d-flex">
                                                        <img className="avatar rounded"
                                                             src="assets/images//xs/avatar10.svg" alt=""/>
                                                        <div className="flex-fill ms-3 text-truncate">
                                                ...
                                                <li className="list-group-item px-md-4 py-3 py-md-4">
                                                    <a href="javascript:void(0);" className="d-flex">
                                                        ...
                                                        <div className="flex-fill ms-3 text-truncate">
                                                            ...
                                                            <span className="text-muted">barbara.kelly@eBazar.com</span>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li className="list-group-item px-md-4 py-3 py-md-4">
                                                    <a href="javascript:void(0);" className="d-flex">
                                                        ...
                                                        <div className="flex-fill ms-3 text-truncate">
                                                            ...
                                                            <span className="text-muted">ruthcornish@eBazar.com</span>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li className="list-group-item px-md-4 py-3 py-md-4">
                                                    <a href="javascript:void(0);" className="d-flex">
                                                        ...
                                                        <div className="flex-fill ms-3 text-truncate">
                                                            ...
                                                            <span className="text-muted">yvonneduncan@eBazar.com</span>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li className="list-group-item px-md-4 py-3 py-md-4">
                                                    <a href="javascript:void(0);" className="d-flex">
                                                        ...
                                                        <div className="flex-fill ms-3 text-truncate">
                                                            ...
                                                            <span className="text-muted">nicolacarl@eBazar.com</span>
                                                        </div>
                                                    </a>
                                                </li>
                                            </ul>
